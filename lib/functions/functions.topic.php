<?php
	/**
		...
		* @category Core
		* @file functions.topic.php
	*/
	
	namespace WPBoard\lib\functions;

	class topic extends \functions {
		public function mark_forum($forum_id = false) {
			global $db, $user;
		...
		public function mark_topic($topic_id, $forum_id, $forum_last_post_time, $forum_mark_time, $last_time) {
			global $db, $user;
		...
		public function poll_vote($row, $option_id) {
			global $db, $user;
		...
		public function close_topic($row) {
			global $db, $user;
		...
		public function important_topic($row) {
			global $db, $user;
		...
		public function delete_topic_post($post_id) {
