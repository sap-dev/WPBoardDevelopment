...
<div id="plugins">
<?php if (template::getVar('pluginServer')=="1"): ?>
	<div class="h2box">
		<h1 class="fLeft" style="width:30%;">Paket Server <span class="light">(<?=template::getVar('pluginServerCount');?>)</span></h1>
	...
	<?php if (template::getVar('pluginServerCount') == 0): ?>
		<div class="info">Es sind keine Paket Server eingetragen.</div>
	<?php endif; ?>
	...
	?>
		<div class="item" <?php if ($plugins['UPDATE']): ?>style="background: #F5F6CE;"<?php endif; ?>>
			<div class="fLeft" style="width: 49%;">
				<span style="font-size: 13px;"><?=$plugins['NAME']; ?></span> <?php if ($plugins['UPDATE']): ?><b>UPDATE</b><?php endif; ?><br /><span class="package"><?=$plugins['PACKAGE']; ?> <?=$plugins['VERSION']; ?></span><br />
			</div>

			<div class="fRight" style="width: 49%; text-align: right; padding-top: 10px;">
				<?php if ($plugins['UPDATE']): ?><a href="<?=$plugins['DLURL']; ?>" class="button greyB"><img src="http://cdn2.iconfinder.com/data/icons/fugue/icon/arrow_circle_double.png" style="vertical-align: middle;"> Updaten</a><? endif; ?>
